...
grouping_paths <- list(
  grouping4 = file.path(Paths$Pipeline_phoneme_grouping_dir, "phoneme_grouping_ALL.csv"),
...
setdatafiles_paths <- list(
  subset_data_grouping4 = file.path(Paths$Pipeline_set_data_files_dir, "subset_data_grouping_ALL.csv"),
