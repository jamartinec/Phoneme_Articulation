...
# Test1
instance_to_fit_path <- "./Modeling_Pipeline/instance_specification/tests/instance_to_fit.csv"
...
instance_to_fit_path <- "./Modeling_Pipeline/instance_specification/tests/instance_to_fit2.csv"
list_of_instances <- read_instances_specifications_lib$read_instances_specifications_modified(instance_to_fit_path)
...
instance_to_fit_path <- "./Modeling_Pipeline/instance_specification/tests/instance_to_fit3.csv"
list_of_instances <- read_instances_specifications_lib$read_instances_specifications_modified(instance_to_fit_path)
...
#Test 4. Combined:
instance_to_fit_path <- "./Modeling_Pipeline/instance_specification/tests/instance_to_fit4.csv"
